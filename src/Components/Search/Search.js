    ...
    return (
        <div className='row g-4 m-4'>
            <div className='col col-md-4 col-sm-6 col-12 '>
                ...
                {search ? (
                    <form  className='h-50 bg ps-4 pt-4'>
                       
                            <label htmlFor="pickFrom">Pick from</label>
                            <input type="text" name="pickFrom" required onChange={(e) => handleChange(e)} />
                            <label htmlFor="pickTo">Pick to</label>
                            <input type="text" name="pickTo" required onChange={(e) => handleChange(e)} />
                            <br />
                            <button type='submit' onClick={() => setSearched(false)} className='btn mt-3 button'>search</button>
            ...
            <div className='col col-md-4 col-sm-6 col-12 radius-5'>
